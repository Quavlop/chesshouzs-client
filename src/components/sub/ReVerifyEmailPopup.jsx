...
export default function ReVerifyEmailPopup({resendEmailVerificationLink, emailVerificationResendMessage, resendLoading, responseType}){
  ...
  return (
    ...
    >
        ...
        <Heading
          ...
          fontSize={'1.5rem'}
        >
          Your account is available already!
        </Heading>
        <Text
          fontSize={'1rem'}
        >
            Before you proceed, we need to verify your email first.
        </Text>
        <Button
           bgColor='none' 
