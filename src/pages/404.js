    ...
    return (
        <Flex
            ...
            <Image 
                ...
                />
            <Heading fontSize={width < 390 ? '20px' : '28px'} mb={'5px'} textAlign={'center'}>Oops.. something must be wrong.</Heading>
            <Text fontSize={width < 390 ? '14px' : '14px'}   mb={'8px'} textAlign={'center'}>The page you're looking for doesn't exist.</Text>
            <Flex
                justifyContent={'center'}
                alignItems={'center'}  
                ...
                px='5px'
            >
                <Button onClick={()=>{router.push('/')}} height={width > 522 ? '100%' : '50px'} width={width > 522 ? '50%' : '90%'} bg='none' whiteSpace={'normal'} wordBreak={'break-word'} border={`1px solid ${secondaryColor}`} color={secondaryColor} _hover={{
                        color : secondaryHover,
                        bg : primaryHover,
                        border : `1px solid ${secondaryHover}`
                    }}>Go to Home Page</Button>  

                <Button onClick={()=>{router.push('/play')}} height={width > 522 ? '100%' : '50px'} width={width > 522 ? '50%' : '90%'} bg={secondaryColor} whiteSpace={'normal'} wordBreak={'break-word'} border={`1px solid ${secondaryColor}`} color={'white'} _hover={{
                        bg : secondaryHover
                    }}>Play</Button>                                                 
